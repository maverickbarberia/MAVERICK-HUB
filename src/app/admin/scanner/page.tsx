      ...
      <div className="w-full max-w-md pt-2 space-y-6 relative z-10 mx-auto">
        ...
        <div className="backdrop-blur-xl bg-white/2 border border-white/8 p-4 sm:p-6 rounded-3xl shadow-[0_0_40px_rgba(0,0,0,0.5)] mx-auto overflow-hidden">
          ...
          {!scannedUserId ? (
            ...
            <div className="w-full rounded-2xl overflow-hidden bg-black/80 backdrop-blur-md border border-white/5 shadow-inner p-6 sm:p-8 text-center flex flex-col items-center justify-center">
              <CheckCircle size={64} strokeWidth={1.5} className="text-green-500 mb-5 drop-shadow-[0_0_15px_rgba(34,197,94,0.5)]" />
              
              <h3 className="text-white font-bold text-2xl mb-2">Cliente Identificado</h3>
              <p className="text-gray-400 text-sm mb-8 break-all w-full max-w-xs mx-auto bg-white/5 p-3.5 rounded-xl border border-white/10">
                {scannedUserId}
              </p>
              ...
              <button
                ...
                className="w-full bg-transparent text-gray-400 font-medium px-6 py-4 rounded-xl hover:text-white transition-colors border border-transparent hover:border-white/10 flex items-center justify-center gap-2"
              >
                <ScanLine size={18} />
                Escanear otro
              </button>
